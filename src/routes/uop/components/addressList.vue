<template>
    <div class="">
        ...
        <div class="integral">
            ...
            <router-link to="/addressManager" tag="div" class="address_edit"><i class="icon-uop_edit"></i> <span>管理地址</span></router-link>
            <div class="address-cont">
                <ul>
                    ...
                    <!-- <li v-for="address in addressList" @click="chooseAddress(address)">
        ...
        methods: {
            ...
            chooseAddress(address){
                if(this.isHasAddress){
                    // debugger;
                    console.log(address);
                    this.$parent.addressInfo.addressId = address.id;
                    this.$parent.addressInfo.username = address.consignee;
                    this.$parent.addressInfo.tel = address.phone;
                    this.$parent.addressInfo.address = address.province + ' ' + address.city + address.address;
                    this.$parent.showAddressList = false;
                    this.$parent.hasAddress = true;
                }else{
                    this.$parent.hasAddress = false;
                }
            }
        }
    }
        ...
        .address-cont{
            ...
            ul{
                li{
                    ...
                    border-bottom: 8rem / $baseFontSize solid #EAEBF0;
                    .address-left{
                        width: 100%;
